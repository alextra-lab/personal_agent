...
**Status:** Accepted (with scope change) — 2026-06-21 (FRE-582); **realized through ADR-0129 as of 2026-08-06 — this ADR has no implementation path of its own**. D1/D2 accepted & sequenced (FRE-583, **absorbed into FRE-1067** / ADR-0129 D2); D3 (OTLP exporter) parked behind FRE-588, **superseded by ADR-0129 D6** (Tempo rather than an EDOT/OTLP intake on existing Elastic) and closed via FRE-1072; D4 confirmed-deferred; D5 adopted and still governing semconv version pinning. Originally Proposed 2026-06-20. Decision log: `docs/research/2026-06-21-fre-582-feedback-loops-proposal-analysis.md`.
