...
| [ADR-0139](ADR-0139-what-the-agent-learns-by-doing.md) | What the Agent Learns by Doing — a Denominator for the Compliance Metric, and Attachments as First-Person Observation (absorbs FRE-1316 vision; D2/D3/D7 withdrawn and D6 retired under ADR-0140 — the ADR-0138 D2 amendment lapses with them) | Proposed — partially withdrawn 2026-09-02 (live: D1 as amended, D4, D5, D8) |
| [ADR-0140](ADR-0140-the-model-is-not-a-security-boundary.md) | The Model Is Not a Security Boundary — Seshat's Declared Threat Model, and the Layer Rule Every Other ADR Cites (intent is not a design input; inputs are untrusted; a model-layer control may never be the sole control for an invariant; retires ADR-0139 D6 and restores ADR-0138 D2's parameter-schema boundary on its invocation axis) | Proposed |
