...
### Dispatch, Delivery Process & Substrate (ADR-0110 – ADR-0129)
...
| [ADR-0129](ADR-0129-opentelemetry-instrumentation-and-trace-visibility.md) | OpenTelemetry Instrumentation, with Trace Visibility as the Acceptance Bar — SDK context propagation, Collector, Tempo (realizes ADR-0093; supersedes ADR-0128's enforcement mechanisms) | Proposed |
