...
| [ADR-0139](ADR-0139-what-the-agent-learns-by-doing.md) | What the Agent Learns by Doing — a Denominator for the Compliance Metric, and Attachments as First-Person Observation (absorbs FRE-1316 vision; D2/D3/D7 withdrawn and D6 retired under ADR-0140 — the ADR-0138 D2 amendment lapses with them) | Proposed — partially withdrawn 2026-09-02 (D1, D4, D8 stand) |
