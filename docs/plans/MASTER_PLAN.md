...
| build2 · Stream 2 · **Sonnet** | `/build 2` | **FRE-692** [S] _(per-attachment cloud/local override UI — PWA; carrier FRE-661 shipped)_ | **KEEP** _(direct follow-on to FRE-691 cost machinery — do not /clear)_ | FRE-693 [S] (image joinability) → FRE-669 seam (master-run) |
| adr · **Opus** | `/adr` | **FRE-736** [O] _(stored-image re-vision ADR — ⚠️ Needs Approval; the owner-bug-investigation shipped as **ADR-0107**/PR #327 Accepted)_ | CLEAR | 639↔ADR-0105 System-isolation reconciliation · pedagogical-reflection ADR (unfiled) |
<!-- STREAM-BOARD:END -->
