...
| adr · **Opus** | `/adr` | **FRE-706** [O] _(recall operating-point sign-off — records values, mirrors FRE-655; feeds FRE-724)_ | CLEAR | **FRE-639↔ADR-0105 reconciliation** (gate-vs-isolate design — fresh adr work, see below) |
<!-- STREAM-BOARD:END -->
