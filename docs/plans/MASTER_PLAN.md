...
> **Last updated**: 2026-05-12 — FRE-328 capture pipeline shipped (PRs #43–47) and verified end-to-end in field test; **parked for natural-usage evaluation**, review gate 2026-05-26. Field test surfaced a naming-stability finding: reflection model names same gap differently across sessions, so the ≥3-across-≥2-sessions threshold can't fire without name normalization. See `docs/plans/fre-328-evaluation-window.md`.
