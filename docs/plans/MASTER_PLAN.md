...
> **Last updated**: 2026-05-13 — FRE-341 execution-service token pruned (direct-to-main). FRE-344 display-name seeding implemented (PR #50, In Review). FRE-299 gate deferred to 2026-05-14 per ADR-0060 14-day precondition.
...
| [FRE-299](https://linear.app/frenchforest/issue/FRE-299) | Low | Haiku | Flip `graph_quality_governance_enabled` gate (gate opens 2026-05-14) |
