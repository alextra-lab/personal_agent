...
| adr · **Opus** | `/adr` | 🔎 **owner bug investigation** _(owner-driven, incoming 2026-07-02 — master to plan + potentially resequence when it surfaces)_ | CLEAR | **FRE-736** [O] (stored-image re-vision ADR, Needs Approval) · pedagogical-reflection ADR (unfiled) |
<!-- STREAM-BOARD:END -->
