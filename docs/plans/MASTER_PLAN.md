...
**Protect-live-rollout cluster (approved 2026-06-02; lead now FRE-437):**
...
| [FRE-437](https://linear.app/frenchforest/issue/FRE-437) | — | Sonnet | **🔵 LEAD** — factor Anthropic cache pricing (read cheaper / creation premium) into `cost_usd`. |
| [FRE-436](https://linear.app/frenchforest/issue/FRE-436) | — | Sonnet | **Bug**: cloud sessions show as `local` in history (profile mis-attribution; cost proves cloud). |
