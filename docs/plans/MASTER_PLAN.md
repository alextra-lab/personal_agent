...
- ✅ **FRE-541** — **ADR-0091 shipped** (PR #216, Proposed; amends ADR-0084 §D4). Umbrella stays In Progress; impl now in 561–564. → spawned **FRE-561/562/563/564 (Needs Approval)** — the eval-validity build chain that **unblocks FRE-453**; **need owner approval to dispatch** (561 doc-only T3 · 562 dataset T2 · 563 driver+detector T2 core · 564 report+validation T2).
- **FRE-554** ← next — session-scoped meter redesign; **interview owner first**, then author the spec → build implements.
