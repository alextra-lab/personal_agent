...
- Sequencing: **576 (audit fixes) → 570 (markers) → 577 (occupancy) → 572 (severity)**. 576 is Opus-tier (per-finding judgment). Not Lane A. Slot into Lane B's orchestrator/compression sub-stream; owner-prioritize vs the 568/573 meter chain.
