...
**Recommended order**: FRE-434 ✅ → FRE-377 ✅ (soak ~06-03) → FRE-408 ✅ → FRE-409 ✅ (FRE-403 EPIC COMPLETE) → **[FRE-399](https://linear.app/frenchforest/issue/FRE-399) Layer 2 (next for build — retry/fallback)** → FRE-400 → FRE-397 Tier 2.
