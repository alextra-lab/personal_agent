...
1. FRE-544 ✅ → 2. FRE-559 ✅ → 3. FRE-546 ✅ → 4. FRE-550 ✅ → 5. FRE-556 ✅ (PR #231, no-deploy) → **6. FRE-558 [S]** setup-es additive live-index mappings ← next → 7. **FRE-567 [S]** generic numeric dynamic_template.
