...
**Recommended order**: FRE-434 ✅ → FRE-377 ✅ (soak ~06-03) → FRE-408 ✅ (shipped; Mac-smoke gated) → **[FRE-409](https://linear.app/frenchforest/issue/FRE-409) (P5, next for build — closes FRE-403 EPIC)** → FRE-399 Layer 2 → FRE-400 → FRE-397 Tier 2.
...
| **I** | Prompt observability | In Progress | [FRE-403](https://linear.app/frenchforest/issue/FRE-403) EPIC (In Progress) · FRE-404 ✅ · FRE-405 ✅ · FRE-406 ✅ · FRE-407 ✅ · FRE-408 ✅ (Mac-smoke gated) · [FRE-409](https://linear.app/frenchforest/issue/FRE-409) (**P5, next — closes EPIC**) · FRE-183 · FRE-184 | FRE-404–408 shipped. EPIC stays In Progress until P5 (FRE-409) ships. |
