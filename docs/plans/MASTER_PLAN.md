...
> **Last updated**: 2026-05-14 — FRE-363 operator stanza bug merged (PR #51) · FRE-326 re-eval complete: host-resource gates retained as deployment-conditional safety valve for local-inference mode (no code change) · FRE-315 mermaid rendering + validated authoring skill + iOS field-test follow-ups (network-first SW, C4 xlink fix, image actions) all shipped via PRs #53 + #56.
