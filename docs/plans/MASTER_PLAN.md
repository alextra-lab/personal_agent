...
|--------|---------|-------------------|---------|--------------|
| build · Stream 1 · **Opus** | `/build 1` | **FRE-707** [O] _(wire closed-axis predicates into recall — structural arm; unblocked, FRE-637 Done)_ | CLEAR | ⚠️ builds **flag-dark** ahead of the v1 fusion core (FRE-722/723/724, still Needs-Approval); FRE-639 [S] parked (FRE-708 decision) |
| build2 · Stream 2 · **Sonnet** | `/build 2` | **FRE-709** [S] _(harden gateway/request-gateway content-stringify sites before list-content lands)_ | CLEAR | FRE-666 (deploy-gate) → **FRE-722** [S] → **FRE-723** [S] (recall v1 core — Approved) |
| adr · **Opus** | `/adr` | ⚠️ **queue exhausted** — FRE-706 shipped (#317); no remaining filed ADR-authoring child (707 is build). Candidate next = **FRE-639↔ADR-0105 reconciliation** (gate-vs-isolate; unfiled — needs owner file+approve) | CLEAR | — |
<!-- STREAM-BOARD:END -->
