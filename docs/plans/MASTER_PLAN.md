...
|--------|---------|-------------------|---------|--------------|
| build · Stream 1 · **Opus** | `/build 1` | ⚠️ **awaiting owner** — no clean NEXT: FRE-639 [S] parked (FRE-708 isolate-vs-gate decision), FRE-707 [O] now unblocked (FRE-637 Done) but wants the v1 fusion core (FRE-722/723/724, Needs-Approval) first | CLEAR | resolve via § owner reassessment (2026-07-01 tick) |
| build2 · Stream 2 · **Sonnet** | `/build 2` | **FRE-709** [S] _(harden gateway/request-gateway content-stringify sites before list-content lands)_ | CLEAR | FRE-666 [tier TBD — master verifies before dispatch] (deploy-gate) |
| adr · **Opus** | `/adr` | **FRE-706** [O] _(recall operating-point sign-off — records values, does not re-design; **not fresh ADR authoring** — adr stream running dry, see § owner reassessment)_ | CLEAR | FRE-707 [O] (structural arm — build, not ADR) |
<!-- STREAM-BOARD:END -->
