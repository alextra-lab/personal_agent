...
| [FRE-440](https://linear.app/frenchforest/issue/FRE-440) | — | Sonnet | **Config-hygiene**: pin frozen-layout default in tracked config (don't depend on gitignored `.env`). |
