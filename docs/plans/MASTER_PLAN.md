...
| adr · **Opus** | `/adr` | **FRE-736** [O] _(stored-image re-vision ADR — re-process a stored image artifact into vision via credentialed fetch; folds the artifact_read binary-URL defect; **Needs owner approval**)_ | CLEAR | pedagogical-reflection ADR (ADR-0106 D7, unfiled) |
<!-- STREAM-BOARD:END -->
