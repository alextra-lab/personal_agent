...
- **build1: ADR-0102 vision docs/PDF chain** (FRE-684/T4 building; 682/683 merged; seam 689 master-run → T5–T9). **build2: ADR-0116 channel track** — FRE-871 **AC-2 proven live**, now building the consolidated **FRE-872** (former T2–T4 end-to-end; 873/874 canceled); **FRE-875 cutover** = ask-first deploy, **deferred to a fresh master** (retires the idle-scrape). **adr: idle.** Parked-Approved (dispatch when a lane frees): FRE-858 recall keep-bugs (733/751/762/760/805/850) · **FRE-876** (config D4 check) · **FRE-867** · **FRE-807**.
