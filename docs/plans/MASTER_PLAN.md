...
|--------|----------|------|------|
| [FRE-468](https://linear.app/frenchforest/issue/FRE-468) | **Urgent** | Sonnet | `cache_control` ≤4 clamp — clear-then-reapply, idempotent across tool loop; assert before send; regression test |
| [FRE-469](https://linear.app/frenchforest/issue/FRE-469) | **High** | Sonnet | Classifier: route artifact/"build me a"/"make an interactive" intent to `tool_use`/`planning` (FRE-256/210 family) |
