...
**Recommended order**: FRE-434 ✅ → FRE-377 ✅ (soak ~06-03) → FRE-408 ✅ → FRE-409 ✅ (FRE-403 EPIC COMPLETE) → FRE-399 Layer 3 ✅ (ADR-0083, PR #139) → **[FRE-400](https://linear.app/frenchforest/issue/FRE-400) (next for build — E2E testing)** → FRE-397 Tier 2.
