...
| build2 · Stream 2 · **Sonnet** _(flip back to Sonnet for 691)_ | `/build 2` | **FRE-691** [S] _(cloud image cost — pricing/pre-flight/ADR-0065 reservation/metering; must precede FRE-692 override UI)_ | CLEAR | FRE-692 [S] → FRE-693 [S]; FRE-734 shipped-pending-smoke |
