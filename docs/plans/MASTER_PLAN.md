...
> **Last updated**: 2026-05-13 — FRE-337 skill nudge injection shipped (PR #48) + XML skill headers follow-up (PR #49). Eval complete: Family A 5/5, Family B 4/4, no regressions. Both PRs deployed and verified.
