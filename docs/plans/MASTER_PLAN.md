...
**Protect-live-rollout cluster (approved 2026-06-02 — build first; lead = FRE-440):**

| Ticket | Priority | Tier | What |
|--------|----------|------|------|
| [FRE-440](https://linear.app/frenchforest/issue/FRE-440) | — | Sonnet | **🔵 LEAD** — pin frozen-layout default in tracked config (don't depend on gitignored `.env`). ⚠️ full-suite blast radius. |
| [FRE-437](https://linear.app/frenchforest/issue/FRE-437) | — | Sonnet | **Cost**: factor Anthropic cache pricing (read cheaper / creation premium) into `cost_usd`. |
