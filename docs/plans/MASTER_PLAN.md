...
| build2 · Stream 2 · **Sonnet** | `/build 2` | **FRE-692** [S] _(per-attachment cloud/local override UI — PWA; carrier FRE-661 shipped)_ | **KEEP** _(direct follow-on to FRE-691 cost machinery)_ | FRE-693 [S] → vision cleanups 726[S]/735[S]/668[H]/742[H] → **master: deploy 691+692+693 + run FRE-669 seam = ADR-0101 DONE** → **then priority waves (Sonnet)**: W0 stability (Config 648→649 · Memory 659/620/632/676/657/677 · Linear 710) → W1 substrate (Config 650→652+735 · Memory 639/640/641/642 · Linear 720/714/715/716) → W2 boundary (728/730→731→732→729 · 738) → W3 (Pedagogical 561→564→453 · Linear 719/718 · Memory 660/647). _(ADR-0102 doc chain 682–689 **owner-PAUSED** — do not build)_ |
