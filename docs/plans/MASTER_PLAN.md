...
|--------|---------|-------------------|---------|--------------|
| build · Stream 1 · **Opus** | `/build 1` | 🔨 **FRE-712** _(building)_ [O] | **KEEP** — direct follow-on; shares the FRE-637/638 extractor+supersession files | FRE-707 [O] (after FRE-705 design) |
...
| adr · **Opus** | `/adr` | 🔨 **FRE-708** _(building)_ [O] | CLEAR | FRE-705 [O] → FRE-706 [O] |
<!-- STREAM-BOARD:END -->
