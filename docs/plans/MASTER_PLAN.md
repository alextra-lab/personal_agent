...
- **build1/build2/adr: all DRY — clean stream pause** (2026-07-12: the ADR-0115 chain FRE-863/864/728/865/868 + retention 860 + cost-fix 869 all shipped; nothing building or queued). Dispatchable-when-owner-sizes: the FRE-858 keep-bugs · **FRE-739** (ADR-0107 assembled seam, Approved-unlabeled) · **FRE-866** (recall structural arm, Low) · **FRE-867** (watcher permission-surfacing) · **FRE-807** parked.
