...
|--------|------|-----|------|------|
| [FRE-518](https://linear.app/frenchforest/issue/FRE-518) | Obs | **High** bug | Opus | Live-render gap: async projector (FRE-513) loses final turn_status/response if client disconnects in completion→emit window. Reconnect re-push / flush-before-close + CI regression test. |
