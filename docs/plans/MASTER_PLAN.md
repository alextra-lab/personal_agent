...
> **Last updated**: 2026-05-15 — Artifact substrate designed end-to-end. **ADR-0069** (R2-backed substrate) and **ADR-0070** (Output channel model: markdown for agent-to-agent, rich for human-facing) landed in Proposed status. **FRE-370 shipped** (CF Access `session_duration=720h` on 6 resources, applied from local terraform). FRE-227 reactivated and rescoped to R2 substrate; **FRE-227 / FRE-368 / FRE-369 now Approved** and ready for execution. Discussion record: `docs/superpowers/plans/i-want-to-research-bubbly-shannon.md`.
