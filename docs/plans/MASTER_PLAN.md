...
| **E2E testing (transport/UI/error)** | [FRE-400](https://linear.app/frenchforest/issue/FRE-400) 🔄 In Progress | PR1 ✅ merged (PR #140): WS harness + 16 tests + CI + Tier-2 buffer tests. FRE-390 cancelled (subsumed). PR2 (PWA Vitest) + PR3 (Playwright) next. |
...
**Recommended order**: FRE-434 ✅ → FRE-377 ✅ (shipped; AC-5 soak ~2026-06-03) → **[FRE-408](https://linear.app/frenchforest/issue/FRE-408) (P4, next for build)** → FRE-409 (P5, closes FRE-403 EPIC) → FRE-399 Layer 2 → FRE-400 → FRE-397 Tier 2.
...
| [FRE-377](https://linear.app/frenchforest/issue/FRE-377) ✅ | Medium | Sonnet | **SHIPPED** (PR #135) — canonicalize TaskCapture token fields. AC-5 soak ~2026-06-03 (see Pending Verification). |
