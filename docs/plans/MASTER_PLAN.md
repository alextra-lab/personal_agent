...
| [FRE-527](https://linear.app/frenchforest/issue/FRE-527) ◑ | Art | — | Sonnet | Toolkit #2 — **in-repo verifier slice landed** (PR #191: `make verify-lib` + manifest + EXECUTABLE_SCRIPT_MIMES). **In Progress** — cross-repo hosting (`personal_agent_secrets` Worker, laptop CC) + live `make verify-lib` pending. Blocks 528/530/531. |
