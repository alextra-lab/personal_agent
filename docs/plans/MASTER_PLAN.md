...
**Recommended order**: ADR-0081 D2/D3 ([FRE-434](https://linear.app/frenchforest/issue/FRE-434) — the local cross-turn latency win; ADR first, then impl) → FRE-377 (quick canonicalization) → FRE-408 (P4) → FRE-399 Layer 2 → FRE-400 → FRE-397 Tier 2.
