...
- [2026-08-07 · owner | relayed 2026-08-07] "We will probably retire Kibana - but not yet, and I accept the cost. We will revisit Kibana once Grafana is online and providing value. For now, it is an idea not yet manifested." Keep Kibana, allow limited dev; gate at each Kibana ticket whether to proceed. · Retires: FRE-1072 (Tempo, Grafana) reaches Done in Linear, at which point the Kibana retirement is revisited
