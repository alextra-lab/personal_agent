...
- [2026-08-05 · owner] At the next clean topic/stream subject break - meaning: when we have completed end-to-end a series of connected tickets, pause. I will start driving the projects and subject I want completed. · Retires: the owner names the next subject after the pause
