...
| **Deploy — everything else**: `seshat-gateway` rebuild · ES type-change or reindex · Postgres schema/migration · cost, budget or governance | `do-and-report` | 2026-08-06 · owner (scoped) · widened to do-and-report globally 2026-08-18 · owner (process streamline) | a sustained incident-free record, owner's call | a deploy causes an incident |
| **Ticket approval — Tier-3 / mechanical**: bugfix · docs · config · test-only (never features or architecture) | `do-and-report` — master may approve + dispatch directly, reporting after | 2026-08-18 · owner (process streamline) | — | a self-approved ticket turns out to be feature/architecture scope, or causes rework |
...
- [2026-08-31 · owner | relayed 2026-08-31] "Waive unless seriously necessary" — on an `escalated` diff class, master merges without asking, and brings one to the owner only where master judges an owner `/code-review ultra` seriously necessary. · Retires: an escalated diff merged under this directive causes an incident
- [2026-09-05 · owner | relayed 2026-09-05] "I still want the model, agent, subagent work fast tracked but with propery prioritization of any other Urgent issues." · Retires: FRE-1394 reaches Done in Linear
