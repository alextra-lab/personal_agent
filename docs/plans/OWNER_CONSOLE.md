...
- [2026-08-05 · owner] "You are approved to rebuild and deploy for these stream. Nothing else is running." / "Standing approval. For this stream." — scoped to the ADR-0132 outbound-egress chain; lifts the `ask-first` gateway-rebuild gate for those tickets only. · Retires: FRE-1144, FRE-1145, FRE-1146 and FRE-1147 all reach Done
