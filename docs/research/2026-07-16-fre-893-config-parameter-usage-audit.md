...
Every one of the 311 typed `AppConfig` fields (`src/personal_agent/config/settings.py`) is categorized from evidence gathered three ways for reads and three ways for overrides:
...
| `agent_owner_email` | `load-bearing` | src:7, scripts:5, tests:7 | docker-compose.eval.yml (compose), /opt/seshat/.env (deployed-env) |
...
| `anthropic_api_key` | `writer-pinned-guardrail` | src:4, scripts:2, tests:7 | docker-compose.eval.yml (compose), /opt/seshat/.env (deployed-env) |
| `approval_timeout_seconds` | `read-but-never-overridden` | src:1, tests:3 | none in-repo |
| `approval_ui_enabled` | `load-bearing` | src:2, tests:5 | docker-compose.eval.yml (compose), /opt/seshat/.env (deployed-env) |
...
| `artifact_resolve_internal_token` | `writer-pinned-guardrail` | src:2 | /opt/seshat/.env (deployed-env) |
...
| `cf_access_client_id` | `load-bearing` | src:8, tests:8 | docker-compose.cloud.yml (compose), /opt/seshat/.env (deployed-env) |
| `cf_access_client_secret` | `writer-pinned-guardrail` | src:8, tests:8 | docker-compose.cloud.yml (compose), /opt/seshat/.env (deployed-env) |
...
| `database_url` | `load-bearing` | src:8, scripts:13, tests:20, self-read, manifest | docker-compose.cloud.yml (compose), docker-compose.eval.yml (compose), tests/conftest.py (test-substrate), /opt/seshat/.env (deployed-env) |
...
| `enable_memory_graph` | `load-bearing` | src:3, tests:2 | /opt/seshat/.env (deployed-env) |
| `enable_reasoning_role` | `never-read` | none | none in-repo |
| `enable_second_brain` | `load-bearing` | src:2, tests:2 | /opt/seshat/.env (deployed-env) |
...
| `freshness_dormant_entity_proposal_threshold` | `load-bearing` | src:2 | /opt/seshat/.env (deployed-env) |
| `freshness_dormant_relationship_proposal_threshold` | `never-read` | none | /opt/seshat/.env (deployed-env) |
| `freshness_enabled` | `load-bearing` | src:8, tests:9 | /opt/seshat/.env (deployed-env) |
...
| `freshness_never_accessed_noise_days` | `never-read` | none | /opt/seshat/.env (deployed-env) |
...
| `gateway_auth_enabled` | `load-bearing` | src:7, tests:3 | docker-compose.cloud.yml (compose), docker-compose.eval.yml (compose), /opt/seshat/.env (deployed-env) |
...
| `graph_quality_governance_enabled` | `load-bearing` | src:1 | /opt/seshat/.env (deployed-env) |
...
| `lexical_arm_enabled` | `load-bearing` | src:2, tests:2 | /opt/seshat/.env (deployed-env) |
| `linear_agent_rate_limit_per_day` | `read-but-never-overridden` | src:1 | none in-repo |
| `linear_api_key` | `writer-pinned-guardrail` | src:7, tests:1 | /opt/seshat/.env (deployed-env) |
...
| `mcp_gateway_enabled` | `load-bearing` | src:3, tests:1 | docker-compose.eval.yml (compose), /opt/seshat/.env (deployed-env) |
...
| `multipath_recall_enabled` | `load-bearing` | src:1, tests:2 | /opt/seshat/.env (deployed-env) |
| `multipath_rrf_k` | `read-but-never-overridden` | src:2 | none in-repo |
| `multiquery_arm_enabled` | `load-bearing` | src:2, tests:2 | /opt/seshat/.env (deployed-env) |
| `neo4j_password` | `writer-pinned-guardrail` | src:2, scripts:21, tests:15 | docker-compose.cloud.yml (compose), docker-compose.eval.yml (compose), /opt/seshat/.env (deployed-env) |
| `neo4j_uri` | `load-bearing` | src:5, scripts:35, tests:15, self-read, manifest | docker-compose.cloud.yml (compose), docker-compose.eval.yml (compose), tests/conftest.py (test-substrate), /opt/seshat/.env (deployed-env) |
| `neo4j_user` | `load-bearing` | src:2, scripts:20, tests:12 | docker-compose.eval.yml (compose), /opt/seshat/.env (deployed-env) |
...
| `perplexity_api_key` | `writer-pinned-guardrail` | src:1, tests:10 | /opt/seshat/.env (deployed-env) |
...
| `prefer_primitives_enabled` | `load-bearing` | src:4, tests:2 | docker-compose.eval.yml (compose), /opt/seshat/.env (deployed-env) |
| `primitive_tools_enabled` | `load-bearing` | src:2, tests:1 | docker-compose.eval.yml (compose), /opt/seshat/.env (deployed-env) |
...
| `recall_similarity_floor` | `load-bearing` | src:3, scripts:3, tests:2 | /opt/seshat/.env (deployed-env) |
...
| `relevance_bounded_recall_enabled` | `load-bearing` | src:2, scripts:1, tests:2 | /opt/seshat/.env (deployed-env) |
...
| `second_brain_idle_time_seconds` | `load-bearing` | src:1 | /opt/seshat/.env (deployed-env) |
| `second_brain_memory_threshold` | `load-bearing` | src:3 | /opt/seshat/.env (deployed-env) |
| `second_brain_min_interval_seconds` | `load-bearing` | src:1 | /opt/seshat/.env (deployed-env) |
| `second_brain_resource_gating_enabled` | `never-read` | none | /opt/seshat/.env (deployed-env) |
...
| `skill_routing_mode` | `load-bearing` | src:3 | /opt/seshat/.env (deployed-env) |
...
| `sysgraph_database_url` | `load-bearing` | src:4, scripts:1, tests:5, self-read | tests/conftest.py (test-substrate), /opt/seshat/.env (deployed-env) |
...
## Hardcode candidates — read-but-never-overridden (186)
