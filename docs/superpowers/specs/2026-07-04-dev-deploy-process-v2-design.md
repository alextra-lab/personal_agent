...
| Webhook/event controller service | **Rejected (dissolved)** | Linear GitHub integration + dispatch contract + existing polling replace every controller responsibility without new infra. |
