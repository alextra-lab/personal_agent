# FRE-1281 span extraction — full-3x-20260824

- partition: **full corpus**
- documents: 156
- extractor: span_extraction role (config/model_roles.yaml)
- degraded documents (post-pass failed closed): 5

## Bars

| bar | observed | required | met |
| --- | --- | --- | --- |
| `recall.overall` | 0.891 | >= 0.9 | NO |
| `precision.overall` | 0.863 | >= 0.8 | yes |
| `decomposition.boundary_f1` | 0.783 | >= 0.75 | yes |
...
| `recall.class.factual_entity` | 0.769 | >= 0.85 | NO |
| `recall.class.nl_in_code` | 1.000 | >= 0.85 | yes |
| `recall.class.prose_about_code` | 1.000 | >= 0.85 | yes |
| `recall.class.prose_in_fence` | 0.767 | >= 0.85 | NO |
| `recall.class.unattributed_restatement` | 0.933 | >= 0.85 | yes |
| `fp_rate.class.attributed_restatement` | 0.000 | <= 0.15 | yes |
| `fp_rate.class.code_body` | 0.000 | <= 0.15 | yes |
| `fp_rate.class.connective_evaluative` | 0.367 | <= 0.15 | NO |
...
| d01-tuna-brands | 3 | 4 | 3 |
| d02-mercury-bare | 3 | 4 | 2 |
| d03-storage-bare | 4 | 5 | 4 |
| d04-city-conjunction | 3 | 3 | 3 |
| d05-rainfall | 3 | 3 | 3 |
| d06-bare-predicates-cooking | 3 | 4 | 3 |
| d07-bare-predicate-mixed | 3 | 3 | 3 |
| d08-httpx-client | 4 | 4 | 2 |
| d09-print-paris | 2 | 3 | 2 |
| d10-comment-claims | 3 | 4 | 3 |
| d11-js-comment | 2 | 2 | 1 |
| d12-install-commands | 2 | 2 | 2 |
...
| d48-shell-comment | 2 | 1 | 1 |
| d49-yaml-comment | 2 | 2 | 1 |
| d50-restatement-and-record | 4 | 4 | 3 |
| d51-arithmetic-and-ordering | 3 | 5 | 3 |
| d52-unattributed-and-dep | 2 | 2 | 2 |
...
| d04-city-conjunction | 3 | 3 | 3 |
| d05-rainfall | 3 | 3 | 3 |
| d06-bare-predicates-cooking | 3 | 2 | 2 |
| d07-bare-predicate-mixed | 3 | 3 | 3 |
| d08-httpx-client | 4 | 3 | 2 |
| d09-print-paris | 2 | 3 | 2 |
| d10-comment-claims | 3 | 4 | 3 |
...
| d26-recommended | 3 | 3 | 3 |
| d27-standard-approach | 3 | 3 | 3 |
| d28-connective-over-cited | 4 | 6 | 4 |
| d29-connective-more | 3 | 4 | 3 |
| d30-connective-ordering | 3 | 3 | 3 |
| d31-restatement-overlap | 2 | 3 | 2 |
| d32-restatement-plain | 2 | 2 | 1 |
...
> 3 samples per document. Overall recall per sample: 0.902, 0.891, 0.880 (min 0.880, max 0.902). The bars above are scored over all samples pooled.
