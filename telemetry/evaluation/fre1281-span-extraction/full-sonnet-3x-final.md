# FRE-1281 span extraction — full-sonnet-3x-final

- partition: **full corpus**
- documents: 156
- extractor: span_extraction role -> claude_sonnet
- degraded documents (post-pass failed closed): 6

## Bars

| bar | observed | required | met |
| --- | --- | --- | --- |
| `recall.overall` | 0.953 | >= 0.9 | yes |
| `precision.overall` | 0.865 | >= 0.8 | yes |
| `decomposition.boundary_f1` | 0.794 | >= 0.75 | yes |
...
| `recall.class.factual_entity` | 0.872 | >= 0.85 | yes |
| `recall.class.nl_in_code` | 0.933 | >= 0.85 | yes |
...
| `fp_rate.class.connective_evaluative` | 0.200 | <= 0.15 | NO |
...
| d26-recommended | 3 | 3 | 3 |
| d27-standard-approach | 3 | 3 | 3 |
| d28-connective-over-cited | 4 | 4 | 4 |
| d29-connective-more | 3 | 3 | 2 |
| d30-connective-ordering | 3 | 2 | 1 |
| d31-restatement-overlap | 2 | 3 | 2 |
| d32-restatement-plain | 2 | 2 | 2 |
...
> 3 samples per document. Overall recall per sample: 0.946, 0.946, 0.967 (min 0.946, max 0.967). The bars above are scored over all samples pooled.
